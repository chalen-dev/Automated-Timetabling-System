...
<div class="timetable-editor">
    @if ($rooms->isNotEmpty())
        {{-- fixed-width wrapper shared with tools --}}
        <div class="mx-auto w-[1450px]">
            <div class="relative overflow-x-auto rounded-lg shadow-md flex flex-col justify-center items-center">

                <div class="flex flex-col bg-white w-[1450px] rounded-t-lg shadow-sm">
                    {{-- TERM SELECTOR --}}
                ...
                {{-- fixed-width canvas table --}}
                <table class="w-[1450px] table-fixed border-collapse text-xs md:text-sm rounded-b-lg">
